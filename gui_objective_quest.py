...
entry_pdf=tk.Entry(frame1,bg='white', font=40, bd=5)
...
btn = tk.Button(frame1, text="Conver image file", bg='gray', font =40, command=lambda: image_to_text(entry_pdf.get()))
...
entry=tk.Entry(frame2,bg='white', font=40, bd=5)
entry.place(relx=0.1, rely=0.1, relwidth=0.3, relheight=0.3)

btn = tk.Button(frame2, text="Click Me", bg='gray', font =40)
# btn.grid(column=1, row=0)
btn.place(relx=0.45,rely=0.1, relwidth=0.2, relheight=0.3)
window.mainloop()
